const dictionary = {
	fr: {
		...
		features: {
			description: [
				'Une app en multi pour mesurer votre vitesse de saisie',
		...
		skills: [
			...
			},
			{
				name: 'Full Stack',
				description:
					"En tant que jeune entrepreneur, j'ai dû me familiariser avec les technologies SaaS, PostgreSQL, Firebase, les services Amazon, etc. Je suis toujours prêt à explorer de nouveaux domaines, et l'IA facilite grandement cette démarche.",
				time: 'depuis 5 ans',
				icon: '💬',
				color: '#FF3D71',
			},
			{
				...
				description:
					"J'ai longtemps été rédacteur-concepteur pour divers sites web spécialisés en technologie tels que Tom's Guide, 01Net ou Phonandroid.",
				time: 'depuis 15 ans',
				icon: '🗞️',
				color: '#1E86FF',
			},
