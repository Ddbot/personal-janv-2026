		...
		features: {
			description: [
				...
				<div key="contact" className="w-full flex justify-end gap-4">
					<button data-icon="message-circle" onClick={handleClick}>
						<MessageCircle color={'var(--background'} />
					</button>
					<button data-icon="mail" onClick={handleClick}>
						<Mail color={'var(--background'} />
					</button>
					<button data-icon="linkedin">
						<a href="https://www.linkedin.com/in/andry-rakotoniaina/" target='_blank'>
